...
ax.set_title('복부 CT/MRI에서 췌장 낭종 유병률(2020년)\n',fontsize=30)
ax.set_ylabel(
                '(단위: %)' # 표시값
                 ,labelpad=-70 # 여백값 설정
                ,fontsize=20 # 글씨크기 설정
...
plt.savefig("{}/03_06_복부CTMR_01췌장낭종_01유병률.png".format(workdir[:-5])
...
# Add some text for labels, title and custom x-axis tick labels, etc.
ax.set_title('복부 CT/MRI에서 췌장 낭종 연령별 유병률(2020년)\n',fontsize=30)
ax.set_ylabel(
                '(단위: %)' # 표시값
                 ,labelpad=-70 # 여백값 설정
                ,fontsize=20 # 글씨크기 설정
...
plt.savefig("{}/03_06_복부CTMR_01췌장낭종_02연령별유병률.png".format(workdir[:-5])
            ,edgecolor='black', dpi=144) #72의 배수

# plt.show()
# %%
# data merge, export
ABD_P_CYST_agegrp_t.to_excel('{}/03_06_복부CTMR_01췌장낭종.xlsx'.format(workdir[:-5]),sheet_name="유병률")
with pd.ExcelWriter('{}/03_06_복부CTMR_01췌장낭종.xlsx'.format(workdir[:-5]), mode='a',engine='openpyxl') as writer:
    ABD_P_CYST_agegrp.to_excel(writer,sheet_name="연령별유병률")
...
# Add some text for labels, title and custom x-axis tick labels, etc.
ax.set_title('복부 CT/MRI에서 췌장 종괴 유병률(2020년)\n',fontsize=30)
ax.set_ylabel(
                '(단위: %)' # 표시값
                 ,labelpad=-70 # 여백값 설정
                ,fontsize=20 # 글씨크기 설정
...
# Add some text for labels, title and custom x-axis tick labels, etc.
ax.set_title('복부 CT/MRI에서 췌장 종괴 연령별 유병률(2020년)\n',fontsize=30)
ax.set_ylabel(
                '(단위: %)' # 표시값
                 ,labelpad=-70 # 여백값 설정
                ,fontsize=20 # 글씨크기 설정
...
# %%
# data merge, export
ABD_P_MASS_agegrp_t.to_excel('{}/03_06_복부CTMR_02췌장종괴.xlsx'.format(workdir[:-5]),sheet_name="유병률")
with pd.ExcelWriter('{}/03_06_복부CTMR_02췌장종괴.xlsx'.format(workdir[:-5]), mode='a',engine='openpyxl') as writer:
    ABD_P_MASS_agegrp.to_excel(writer,sheet_name="연령별유병률")
...
# Add some text for labels, title and custom x-axis tick labels, etc.
ax.set_title('복부 CT/MRI에서 질환별 유병률(2020년)\n',fontsize=30)
ax.set_ylabel(
                '(단위: %)' # 표시값
                 ,labelpad=-70 # 여백값 설정
                ,fontsize=20 # 글씨크기 설정
...
# Add some text for labels, title and custom x-axis tick labels, etc.
ax.set_title('복부 CT/MRI에서 질환별 연령별 유병률(2020년, 남자)\n',fontsize=30)
ax.set_ylabel(
                '(단위: %)' # 표시값
                 ,labelpad=-70 # 여백값 설정
                ,fontsize=20 # 글씨크기 설정
...
plt.savefig("{}/03_06_복부CTMR_03췌장낭종종괴_03연령별유병률_남자.png".format(workdir[:-5])
            ,edgecolor='black', dpi=144) #72의 배수
# %%
...
# Add some text for labels, title and custom x-axis tick labels, etc.
ax.set_title('복부 CT/MRI에서 질환별 연령별 유병률(2020년, 여자)\n',fontsize=30)
ax.set_ylabel(
                '(단위: %)' # 표시값
                 ,labelpad=-70 # 여백값 설정
                ,fontsize=20 # 글씨크기 설정
...
fig.tight_layout()
plt.savefig("{}/03_06_복부CTMR_03췌장낭종종괴_03연령별유병률_여자.png".format(workdir[:-5])
            ,edgecolor='black', dpi=144) #72의 배수
# %%
